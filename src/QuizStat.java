...
/**
 * A custom data-type that represents the statistics associated with a Quiz. Currently, a QuizStat
 * stores the date the Quiz was taken and the score received.
 * @author jack
 */
